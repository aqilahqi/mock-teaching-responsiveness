    ...
    <div class="h-screen relative">
        ...
        <div class="dock dock-lg fixed bottom-0 left-0 w-full bg-base-200 shadow-md">
            ...
            <router-link to="/responsive" class="dock-item" :class="{ 'dock-active': $route.path === '/responsive' }">
                ...
                <span class="dock-label">Responsive</span>
            </router-link>
        </div>
    </div>
</template>
